...
export function Sidebar() {
    ...
    return (
        <aside className="w-[80px] md:w-[250px] shrink-0 h-full flex flex-col justify-between py-4 px-2 md:px-4 border-r border-slate-800">
            <div className="flex flex-col space-y-4">
                ...
                <nav className="flex flex-col space-y-2">
                    <SidebarLink icon={<Home />} label="Home" href="/" active />
